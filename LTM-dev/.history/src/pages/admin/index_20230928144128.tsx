...
import { COLORS, currentUserState } from "@/constants";
...
const Admin = () => {
  ...
  const handleUpload = async (e) => {
    ...
    const response = await postApiMultipart(
      `/api/document/${currentUser.id}/upload`, // Sử dụng tham số "id" để tạo đường dẫn phù hợp
      formData
    );
    setText(response.data.documentName);
